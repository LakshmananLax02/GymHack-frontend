    ...
    <section className="py-12 md:py-24 bg-white overflow-hidden font-sans">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-gray-500 text-sm md:text-xl font-medium tracking-tight px-4">
        ...
        <div className="flex justify-center gap-3 md:gap-6 mb-10 md:mb-16">
          <button 
            ...
            className={`px-6 md:px-12 py-2 rounded-full border-2 font-bold text-sm md:text-lg uppercase tracking-widest transition-all duration-300 ${
        ...
        <div className="relative flex items-center justify-center min-h-[500px] md:min-h-[650px]">
          ...
          {/* Nav Arrows - High Z-Index to stay clickable */}
          <button 
            onClick={prevSlide} 
          ...
          <div className="w-full overflow-hidden px-2">
            ...
            >
              {filteredProducts.map((product) => (
                ...
                >
                  {/* PRODUCT CARD */}
                  <div className="relative w-full aspect-[3/4] mb-6 md:mb-8 cursor-pointer rounded-[30px] md:rounded-[40px] overflow-hidden bg-[#f8f8f8] border border-black/5">
                    ...
                    <div className="absolute inset-0 z-20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-white/40 backdrop-blur-[2px]">
                      <button className="flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-full font-bold uppercase text-xs md:text-sm shadow-xl transition-all duration-300 bg-[#c23d6a] text-white hover:bg-[#f2eadf] hover:text-black hover:border-black border-transparent border">
                  ...
                  <div className="flex justify-between items-start w-full px-2 gap-2 md:gap-4">
                    <div className="min-h-[60px] md:min-h-[80px]">
                      <h3 className="text-lg md:text-xl font-bold leading-tight text-black uppercase max-w-[150px] md:max-w-[200px]">
                        {product.name}
                      </h3>
                    </div>
                    <span className="text-2xl md:text-4xl font-black text-black whitespace-nowrap">
                      ₹{product.price}
                    </span>
                  </div>
                </div>
